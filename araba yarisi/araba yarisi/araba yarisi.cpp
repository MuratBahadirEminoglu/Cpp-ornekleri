...
void gameover() {
	...
	cout << "\t\t--------------------------" << endl << endl;
	cout << "\t\tMenüye geri dönmek için herhangi bir tuşa basın.";
	getch();
}
void updateScore() {
...
void instructions() {
	...
	cout << "Talimatlar";
	cout << "\n----------------";
	cout << "\n Sola veya sağa hareket ederek arabalardan kaçının. ";
	cout << "\n\n Sola gitmek için 'A'ya basın";
	cout << "\n Sağa gitmek için 'D'ye basın";
	cout << "\n Çıkmak için 'Escape' tuşuna basın";
	cout << "\n\nMenüye geri dönmek için herhangi bir tuşa basın";
	getch();
}
...
void play() {
	...
	gotoxy(WIN_WIDTH + 7, 2); cout << "Araba Yarışı";
...
int main()
{
	...
	do {
		...
		gotoxy(10, 7); cout << " -------------------------- ";
		gotoxy(10, 9); cout << "1. Başla";
		gotoxy(10, 10); cout << "2. Nasıl Oynanır?";
		gotoxy(10, 11); cout << "3. Çıkış";
